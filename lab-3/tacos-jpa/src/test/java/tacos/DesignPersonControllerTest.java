...
public class DesignPersonControllerTest {
  ...
  private List<Hobby> ingredients;
  ...
  public void setup() {
    ...
    when(hobbyRepository.findById("FLTO")).thenReturn(Optional.of(new Hobby("FLTO", "Flour Tortilla", Type.WRAP)));
    when(hobbyRepository.findById("GRBF")).thenReturn(Optional.of(new Hobby("GRBF", "Ground Beef", Type.PROTEIN)));
    when(hobbyRepository.findById("CHED")).thenReturn(Optional.of(new Hobby("CHED", "Cheddar", Type.CHEESE)));

    design = new Person();
    design.setName("Test Taco");

    design.setHobbies(Arrays.asList(
        new Hobby("FLTO", "Flour Tortilla", Type.WRAP),
        new Hobby("GRBF", "Ground Beef", Type.PROTEIN),
        new Hobby("CHED", "Cheddar", Type.CHEESE)
  ));
